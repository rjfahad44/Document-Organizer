...
class AddNewCategoryActivity : AppCompatActivity(), FieldDeleteListener, IconClickListener {
    ...
    private fun initializeWidget() {
        ...
        saveTv = findViewById(R.id.updateBtnTv)
        ...
        folderIcon.setImageResource(R.drawable.i0)
    ...
    private fun addField() {
        ...
        saveBtnTv.setOnClickListener {
            if (categoryNameEt.text.toString().isNotEmpty()){
                ...
                Toast.makeText(this@AddNewCategoryActivity, "Category Name is Empty!", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun chooseCategoryIcon() {
        ...
        //show icon into the icon chooser dialog//
        iconList = ArrayList()
    ...
    private fun addCategory() {
        categoryNameEt.doOnTextChanged { text, start, before, count ->
            if (text!!.isNotEmpty()){
                saveTv.isEnabled = true
                saveTv.setTextColor(ContextCompat.getColor(this, R.color.blue))
                saveTv.compoundDrawables.getOrNull(2)?.setTint(ContextCompat.getColor(this, R.color.blue))
                saveTv.setOnClickListener {
                    if (categoryNameEt.text.toString().isNotEmpty()) {
                        val model = CategoryModel(0, icon, iconBgColor, categoryNameEt.text.toString())
                ...
                saveTv.setTextColor(ContextCompat.getColor(this, R.color.toolbar_btn_icon_bg))
                saveTv.compoundDrawables.getOrNull(2)?.setTint(ContextCompat.getColor(this, R.color.toolbar_btn_icon_bg))
            }
        }
    }
